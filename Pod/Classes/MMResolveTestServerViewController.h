...
@interface MMResolveTestServerViewController : UIViewController <UITableViewDataSource, NSNetServiceBrowserDelegate, UITableViewDelegate, NSNetServiceDelegate>
